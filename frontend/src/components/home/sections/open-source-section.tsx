  ...
  const items = [
    {
      ...
      description: 'Protect your industrial operations with bank-level security, on-premise deployment options, and complete data sovereignty for manufacturing and logistics systems.',
    ...
    },
    {
      ...
      title: 'Global Industrial Expertise',
      description: 'Accelerate your digital transformation with proven implementations across manufacturing, logistics, and engineering services. Deliver incredible ROI from day one.',
      showFeatures: true,
    },
  ];
        ...
        <div className="max-w-6xl mx-auto border-l border-r border-border">
          ...
          <SectionHeader>
            <h2 className="text-3xl md:text-4xl font-medium tracking-tighter text-center text-balance">
              Built for Industrial Enterprise
            </h2>
            <p className="text-muted-foreground text-center text-balance font-medium">
              Purpose-built AI workers for manufacturing, logistics, and engineering services with enterprise security and proven ROI.
            </p>
          </SectionHeader>
              ...
              {item.showSecurityFeatures && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium">SOC 2 Compliant</h4>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium">On-Premise Deploy</h4>
                      <p className="text-muted-foreground text-sm">
                        Keep data in-house
                      </p>
                    </div>
              ...
              {item.showFeatures && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium">Expert Training</h4>
                      <p className="text-muted-foreground text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium">Rapid Implementation</h4>
                      <p className="text-muted-foreground text-sm">
