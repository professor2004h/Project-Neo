                  ...
                  <div>
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      ...
                      <li>
                        ...
                        Company, specifically legal@leaker-flow.com
                      </li>
                      <li>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      please write to legal@leaker-flow.com and we will process and
                    ...
                    <p className="text-muted-foreground text-balance mb-4">
                      ...
                      or by emailing us at legal@leaker-flow.com. If you cancel
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      by emailing us at{' '}
                      <a
                        href="mailto:legal@leaker-flow.com"
                        className="text-secondary hover:underline"
                      >
                        legal@leaker-flow.com
                      </a>
                      .
                    </p>
                  </div>
