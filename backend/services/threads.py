...
from shared.auth_utils import verify_and_get_user_id_from_jwt, verify_and_authorize_thread_access, require_thread_access, AuthorizedThreadAccess
...
async def get_user_threads(
    ...
    try:
        ...
        if unique_project_ids:
            from shared.query_utils import batch_query_in
...
async def create_thread(
    ...
    try:
        ...
        from shared.logger import structlog
