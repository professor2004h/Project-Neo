...
allowed_origins = ["https://www.suna.so", "https://agentiqtest.site",
                   "https://api.agentiqtest.site" "https://suna.so"]
allow_origin_regex = None

# Add staging-specific origins
if config.ENV_MODE == EnvMode.LOCAL:
    allowed_origins.append("https://agentiqtest.site")
...
app.add_middleware(
    ...
    allow_headers=["Content-Type", "Authorization", "X-Project-Id", "X-MCP-URL",
                   "X-MCP-Type", "X-MCP-Headers", "X-Refresh-Token", "X-API-Key"],
)
