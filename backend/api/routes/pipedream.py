...
from shared.auth_utils import verify_and_get_user_id_from_jwt
from pipedream.profile_service import ProfileService, Profile, ProfileServiceError, ProfileNotFoundError, ProfileAlreadyExistsError, InvalidConfigError, EncryptionError
from pipedream.connection_service import ConnectionService
from pipedream.app_service import get_app_service
from pipedream.mcp_service import MCPService, ConnectionStatus, MCPConnectionError, MCPServiceError
from pipedream.connection_token_service import ConnectionTokenService
...
async def get_credential_profile(
    ...
    try:
        ...
        if not profile:
            from pipedream.profile_service import ProfileNotFoundError
